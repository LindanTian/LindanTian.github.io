...
var _mobileDetect = __webpack_require__(2);
...
saveToPayUI.util.showErrorModal = function (title, msg) {
	(0, _sweetalert2.default)({
		...
		onOpen: function onOpen(modal) {
			saveToPayUI.util.blurFocusOfCloseBtn(modal);
		}
	}).catch(_sweetalert2.default.noop);
};

saveToPayUI.util.showWarnModal = function (url) {
	(0, _sweetalert2.default)({
		title: '',
...
saveToPayUI.util.showQRModal = function (url) {
	(0, _sweetalert2.default)({
		title: '',
...
saveToPayUI.showWelcomeModal = function (response) {
	...
	if (deviceOS === 'AndroidOS') {
		...
		saveToPayUI.util.showWarnModal(response.welcomeUrl);
	} else {
		saveToPayUI.util.showQRModal(response.welcomeUrl);
	}
};
